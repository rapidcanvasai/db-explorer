...
import { ChevronRight, ChevronDown, Table2, KeyRound, Link, Diamond } from 'lucide-react';
...
export default function TableTreeItem({ table, meta, isActive, onSelect }: Props) {
  ...
  return (
    <div>
      {/* Table row */}
      <div
        className={`flex items-center text-xs hover:bg-accent transition-colors cursor-pointer ${
      ...
      >
        ...
        <button
          ...
          className="flex-1 flex items-center justify-between py-1.5 pr-3 min-w-0"
        >
